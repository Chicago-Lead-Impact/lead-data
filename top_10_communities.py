...
# plt.subplot(2, 1, 1)
fig, ax = plt.subplots()
for name in high_rates:
  plt.plot(years, ldpp_df[name], label=name)
  plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
  plt.title('Top 10 Communities with the Highest Lead Poisoning Rates')
  plt.xlabel('Year')
...
# #Plot the bottom 10 communities
# plt.subplot(2, 1, 2)
...
mpld3.save_html(fig, 'top_10_communities.html')
